...
<table width="1000" border="1" style="border-collapse: collapse" align="center" bgcolor="white">
	...
	<th width="120"><font face="Arial, Helvetica, sans-serif" size="2">Total Student Attempts</font></th>
	<th width="120"><font face="Arial, Helvetica, sans-serif" size="2">Total Student Attempts at or above 3</font></th>
	<th width="120"><font face="Arial, Helvetica, sans-serif" size="2">Overall Student Average</font></th>
		<th width="120"><font face="Arial, Helvetica, sans-serif" size="2">Last Three Student Attempts at or above 3</font></th>
	<th width="120"><font face="Arial, Helvetica, sans-serif" size="2">Last Three Student Average</font></th>
...
?>
   ...
   <td align="left" width="400"><font face="Arial, Helvetica, sans-serif" size="2"><?php  echo "$learningoutcomename"; ?>&nbsp;</font></td>
	...
	<td><font face="Arial, Helvetica, sans-serif" size="2"><?php  echo "$scoreavg"; ?>&nbsp;</font></td>
		<td><font face="Arial, Helvetica, sans-serif" size="2"><?php  echo "$recentover3"; ?>&nbsp;</font></td>
...
WHERE studentsisid='$studentid' AND coursename='$coursename' $assessmentfilter AND learningoutcomeid='$learningoutcomeid' Group by assessmentid ORDER by AssessmentID ASC"; 
