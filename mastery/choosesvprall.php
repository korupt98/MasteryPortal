...
<p style="text-align: center;"><font face="Arial" size="5"><br>Choose Student</font></p>
</td></tr>
...
<form action="studentviewprall.php" method="post">
<b>Enter Student:</b>
...
<input type="submit" value="Select Student" name="add">
</form>
