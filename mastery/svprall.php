...
<a href="javascript:ReverseDisplay('<?php $coursename; ?>')">show/hide course</a></center>
<div id="<?php  echo $coursename; ?>">
...
?>
<a href="javascript:ReverseDisplay('<?php  echo "$learningoutcomename"; ?>')">show/hide learning outcome</a></center>
<div id="<?php  echo "$learningoutcomename"; ?>">
...
?>
 ...
 <tr align="top"> <a href="javascript:ReverseDisplay('<?php  echo "$assessmenttitle"; ?>')">show/hide assessment title</a></center>
<div id="<?php  echo "$assessmenttitle"; ?>">
